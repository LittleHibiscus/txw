...
<div class="mail" id="main">
        <div class="tabA mgt10">
            <a class="active" @click="change">直接预订</a>
        ...
        <div class="mgb10 lh26" style=" margin:15px 0 0 15px;">
            暂时只提供<b>直接预订</b>且以201开头的订单查询。<a href="#" id="getSuppliers">点击查看支持的供应商</a>。
                非201订单请<a href="https://help.skyscanner.net/hc/zh-cn/categories/200117671-%E9%A2%84%E8%AE%A2" target="view_window">点击这里</a>获取帮助。
        </div>
		...
		<div class="main_num" style="background-color: #fafafa;" id="queryBody">
            ...
            <div class="loginbox" style="width:60%">
                ...
                <dl>
                    ...
                    <div class="fl">
                        <span class="cur mgl5"><img src="captcha.php?bg=250&amp;r=1560174509" class="captcha" id="verify_code_img" target="verify_code" title="点击刷新" align="absmiddle"></span>
                    </div>
                    </dd>
                </dl>
                <dl>
